...
class Account_IndexControllerTest extends Zend_Test_PHPUnit_ControllerTestCase
{
    ...
    {
        $params = array('action' => 'auth', 'controller' => 'Index', 'module' => 'account');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    {
        $params = array('action' => 'verify', 'controller' => 'Index', 'module' => 'account');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    {
        $params = array('action' => 'showAccount', 'controller' => 'Index', 'module' => 'account');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
